    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.php"><img src="assets/images/0logo.svg" alt="logo" /></a>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tabla de Control de Tensión</h4>
                    <p class="card-description"> MEDIDORES <code>MT880</code>
                    </p>
                      ...
                      <table class="table" id="Mytable">
                        <thead>
                          <tr>
                            <th>Estado</th>
                            <th>Meter Name</th>
                            <th>Tensión L1 MAX</th>
                            <th>Fecha</th>
                            <th>Tensión L2 MAX</th>
                            <th>Fecha</th>
                            <th>Tensión L3 MAX</th>
                            <th>Fecha</th>
                            <th>Tensión L1 MIN</th>
                            <th>Fecha</th>
                            <th>Tensión L2 MIN</th>
                            <th>Fecha</th>
                            <th>Tensión L3 MIN</th>
                            <th>Fecha</th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <?php
                          $commands = escapeshellcmd('/var/www/html/santa/tensionx.py');
                                ...
                                echo "No content<br>";
                                  ...
                                  if (count($data->stand)) {
                                      ...
                                      foreach ($data->stand as $idx => $stand) {
                                          $minl1 = $stand -> L1MIN;
                                          if(floatval($minl1)<190){
                                            $classf = "<td class='btn btn-danger'>Danger</td>";
                                          }else{
                                            $classf = "<td class='btn btn-success'>Normal</td>";
                                          }
                                          // Output a row
                                         # echo "<tr class='$stand->L1MAX-CLASS'>";
                                          echo "<tr>";
                                          echo $classf;
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © CLYFSA 2021</span>
